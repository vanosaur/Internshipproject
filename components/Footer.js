...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-800 text-gray-300 py-12 p-40">
      <div className="container mx-auto px-4 p-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 pb-10 border-b border-gray-700">
              ...
              <div className="footer-list flex space-x-8"> {/* Use flex to arrange columns */}
                <ul className="space-y-2">
                  {firstColumnLinks.map((link, index) => (
                    <li key={index}>
                      <Link href={link.href} className="flex items-center text-md hover:text-blue-400 transition-colors">
          ...
          <div className="col-span-1 lg:col-span-2"> {/* Takes more space for contact info */}
            <div className="widget contact-widget">
              ...
              <p className="text-md leading-relaxed mb-4">
                <span className="font-semibold text-white">For more then 30 years,<br/>
